...
const FeedPage = dynamic(() => import("@/app/(app)/feed/page"), { ssr: false });
const AnalyzePage = dynamic(() => import("@/app/(app)/analyze/page"), { ssr: false });
const BacktestPage = dynamic(() => import("@/app/(app)/backtest/page"), {
  ssr: false,
});
