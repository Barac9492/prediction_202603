  ...
  return (
        <div className="space-y-6">
              <div className="flex items-center justify-between">
                      <div>
                                <h1 className="text-2xl font-bold">Investment Theses</h1>h1>
          ...
          {showForm && (
                  <form
                            ...
                            >
                            <h2 className="font-semibold text-sm text-zinc-300">New Investment Thesis</h2>h2>
                            <div className="grid grid-cols-2 gap-4">
                                        <div className="col-span-2">
                                                      <label className="block text-xs text-zinc-400 mb-1">Title</label>label>
                                                      <input
                                                                        required
                                        ...
                                        <div className="col-span-2">
                                                      <label className="block text-xs text-zinc-400 mb-1">Description</label>label>
                                                      <textarea
                                                                        required
                                                                        rows={3}
                                        ...
                                        <div>
                                                      <label className="block text-xs text-zinc-400 mb-1">Direction</label>label>
                                                      <select
                                                                        className="w-full rounded bg-zinc-800 border border-zinc-700 px-3 py-2 text-sm focus:outline-none"
                                                                        value={form.direction}
                                                                        onChange={(e) => setForm({ ...form, direction: e.target.value })}
                                                                      >
                                                                      <option value="bullish">Bullish</option>option>
                                                                      <option value="bearish">Bearish</option>option>
                                                                      <option value="neutral">Neutral / Watch</option>option>
                                                      </select>select>
                                        </div>div>
                                        <div>
                                                      <label className="block text-xs text-zinc-400 mb-1">Domain</label>label>
                                                      <select
                                                                        className="w-full rounded bg-zinc-800 border border-zinc-700 px-3 py-2 text-sm focus:outline-none"
                                                                        value={form.domain}
                                                                        onChange={(e) => setForm({ ...form, domain: e.target.value })}
                                                                      >
                                                                      <option value="AI">AI</option>option>
                                                                      <option value="Infra">Infrastructure</option>option>
                                                                      <option value="SaaS">SaaS</option>option>
                                                                      <option value="Semiconductor">Semiconductor</option>option>
                                                                      <option value="VC">VC/Funding</option>option>
                                                      </select>select>
                                        </div>div>
                                        <div className="col-span-2">
                                                      <label className="block text-xs text-zinc-400 mb-1">Tags (comma-separated)</label>label>
                                                      <input
                                                                        className="w-full rounded bg-zinc-800 border border-zinc-700 px-3 py-2 text-sm focus:outline-none focus:border-zinc-500"
          ...
          {loading ? (
                  <div className="text-zinc-500 text-sm">Loading theses...</div>div>
                ) : theses.length === 0 ? (
                  <div className="rounded-lg border border-zinc-800 p-8 text-center text-zinc-500">
                            <p className="text-lg mb-2">No theses yet</p>p>
                            <p className="text-sm">Create your first investment thesis to start tracking signals.</p>p>
                  </div>div>
                ) : (
                                              ...
                                              <div className="flex items-start justify-between gap-4">
                                                              <div className="flex-1 min-w-0">
                                                                                <div className="flex items-center gap-2 mb-1">
                                                                                                    <span
                                                                                                                            className={`text-xs font-semibold px-2 py-0.5 rounded border ${
                                                                                                                                                      DIRECTION_COLORS[thesis.direction as keyof typeof DIRECTION_COLORS] ||
                                                                                                                                                      DIRECTION_COLORS.neutral
                                                                                                                              }`}
                                                                                                                          >
                                                                                                      {thesis.direction.toUpperCase()}
                                                                                                      </span>span>
                                                                                                    <span className="text-xs text-zinc-500">{thesis.domain}</span>span>
                                                                                  {!thesis.isActive && (
                                                                      <span className="text-xs text-zinc-600 border border-zinc-700 px-2 py-0.5 rounded">
                                                                                ...
                                                                                <h3 className="font-medium text-sm mb-1">{thesis.title}</h3>h3>
                                                                                <p className="text-xs text-zinc-400 leading-relaxed">{thesis.description}</p>p>
                                                              ...
                                                              <div className="flex flex-col items-end gap-2 shrink-0">
                                                                                <span className="text-xs text-zinc-600">#{thesis.id}</span>span>
                                                                                <button
