...
export default async function RecommendationsPage() {
  const allRecs = await listRecommendations({ limit: 200 });
      ...
      <section>
        ...
        {active.length === 0 ? (
          <div className="rounded-lg border border-pm-border bg-white p-6 text-center text-pm-muted">
            No active recommendations. Run the generator to create some.
          </div>
        ) : (
                ...
                >
                  ...
                  {rec.thesisId && (
                    <Link
                      ...
                      className="mb-2 block text-xs text-pm-blue hover:underline"
                    >
                      View linked thesis →
                    </Link>
                  )}
